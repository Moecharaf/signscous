...
export default function BannersArtworkPage() {
  ...
  return (
    <section className="mx-auto max-w-4xl px-6 py-16 text-zinc-100">
      <h1 className="text-4xl font-black">Upload Artwork — Banners</h1>
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        ...
        <Link to="/banners" className="rounded-xl border border-white/15 px-5 py-3 text-sm font-semibold text-zinc-200 hover:bg-white/5">
          Back to Quote
        </Link>
      </div>
    </section>
